...
SCENARIO_TERMS = {
    ...
    "quarterly": ["Quarterly Revenue Breakdown", "Sheet: Quarterly Deep Dive", "Q1 2025"],
    "quarter": ["Quarterly Revenue Breakdown", "2.2 Quarterly Revenue", "Q1 2025"],
    "q1": ["Q1 2025", "Quarterly Revenue Breakdown"],
    "q2": ["Q2 2025", "Quarterly Revenue Breakdown"],
    "q3": ["Q3 2025", "Quarterly Revenue Breakdown"],
    "q4": ["Q4 2025", "Quarterly Revenue Breakdown"],
    "ebitda": ["Sheet: Quarterly Deep Dive", "EBITDA", "Sheet: P&L Statement"],
    "gross margin": ["Sheet: Quarterly Deep Dive", "Gross Margin", "Sheet: P&L Statement"],
    "pipeline": ["MediAIConnect", "IntelliRAG", "Pipeline", "Status: Q"],
    "action items": ["Action Items", "Assignee"],
    "action": ["Action Items", "Assignee"],
